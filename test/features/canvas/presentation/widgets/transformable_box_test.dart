...
void main() {
  group('TransformableBox Tests', () {
    ...
    testWidgets(
      'dragging with snapping accumulates continuous displacement and unsnaps smoothly',
      (tester) async {
        var currentPos = const Offset(20, 100);
                  ...
                  body: Stack(
                    children: [
                      TransformableBox(
                        ...
                        child: const Text('Snapping Drag Box'),
                      ),
                    ],
                  ),
                ),
        ...
        final gesture = await tester.startGesture(
          tester.getCenter(find.text('Snapping Drag Box')),
        );
        for (var i = 0; i < 15; i++) {
        ...
        expect(currentPos.dx, greaterThan(24));
      },
    );
